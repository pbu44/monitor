...
from utils.MQ_client import CloudAMQPClient
...
myHostname = "newsbytes.redis.cache.windows.net"
myPassword = "e5xLE163L5CG5tvkWzb6fS2txykE67IzgAzCaOkXtVI="
NEWS_API_KEY = "d773a10748e941608c7a214c4f832245"

SCRAPE_NEWS_TASK_QUEUE_NAME = "scrape_news_msg_queue"


# connect redis_client and cloundAMQP_client
redis_client = r = redis.StrictRedis(host=myHostname, port=6380,
                      password=myPassword, ssl=True)
cloudAMQP_client = CloudAMQPClient(SCRAPE_NEWS_TASK_QUEUE_NAME)
